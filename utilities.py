...
GS_RALP = []
GS_RALP.append((1, '3+4'))
GS_RALP.append((3, '3+4'))
GS_RALP.append((4, '3+4'))
GS_RALP.append((14, '5+4'))
GS_RALP.append((19, '3+4'))
GS_RALP.append((20, '3+4+5'))
GS_RALP.append((21, '4+3'))
GS_RALP.append((24, '3+4'))
GS_RALP.append((29, '4+3'))
GS_RALP.append((30, '4+3+5'))
GS_RALP.append((32, '3+4'))
GS_RALP.append((36, '3+3+4'))
GS_RALP.append((37, '4+5'))
GS_RALP.append((39, '3+4'))
GS_RALP.append((45, '4+3+5'))
GS_RALP.append((47, '4+5'))
GS_RALP.append((52, '4+5'))
GS_RALP.append((55, '3+4'))
GS_RALP.append((56, '3+4'))
GS_RALP.append((58, '3+4'))
GS_RALP.append((61, '4+3'))
GS_RALP.append((62, '4+3'))
GS_RALP.append((63, '4+3'))
GS_RALP.append((68, '3+4'))
GS_RALP.append((73, '3+4'))
GS_RALP.append((77, '4+3+5'))
GS_RALP.append((80, '3+4'))
GS_RALP.append((81, '4+3'))
GS_RALP.append((83, '4+3'))
GS_RALP.append((84, '4+3+5'))
GS_RALP.append((89, '4+5'))
GS_RALP.append((90, '3+4'))
GS_RALP.append((91, '3+4'))
GS_RALP.append((92, '4+3'))
GS_RALP.append((95, '4+3+5'))
GS_RALP.append((96, '4+3+5'))
GS_RALP.append((97, '3+4'))
GS_RALP.append((99, '4+3'))
GS_RALP.append((100, '3+4'))
GS_RALP.append((103, '3+3'))
GS_RALP.append((104, '3+4'))
GS_RALP.append((105, '3+4'))
GS_RALP.append((108, '3+3+4'))
GS_RALP.append((109, '4+4'))
GS_RALP.append((111, '3+4'))
GS_RALP.append((116, '4+3+5'))
GS_RALP.append((117, '3+4'))
GS_RALP.append((124, '4+3'))
GS_RALP.append((125, '3+4'))
GS_RALP.append((128, '4+5'))
GS_RALP.append((130, '3+4'))
GS_RALP.append((133, '3+4'))
GS_RALP.append((135, '3+4'))
GS_RALP.append((136, '4+3+5'))
GS_RALP.append((139, '4+3'))
GS_RALP.append((140, '4+4'))
GS_RALP.append((143, '4+5'))
GS_RALP.append((145, '3+4'))
GS_RALP.append((147, '3+4'))
GS_RALP.append((150, '4+3'))
GS_RALP.append((154, '4+3'))
GS_RALP.append((161, '3+4+5'))
GS_RALP.append((163, '3+5'))
GS_RALP.append((174, '3+4'))
def read_GS_RALP(case):
    case_GS = GS('x')
    case_row = -1
    case_col = -1
    case_col_MRI_L = -1    
    for row_i in range(len(GS_RALP)):
        if GS_RALP[row_i][0] == case:
            case_GS = GS(GS_RALP[row_i][1])
            case_row = row_i
            case_col = -1
            case_col_MRI_L = -1    

    return case_GS, case_row, case_col, case_col_MRI_L
        ...
        for row in spamreader:
            if row_no == 0:
                for col_i in range(len(row)):
                    col = row[col_i]
                    GT_data.append({'name':col, 'data':[]})
            else:
                for col_i in range(len(row)):
                    col = row[col_i]
                    if GT_data[col_i]['name'] == 'GT1' or GT_data[col_i]['name'] == 'GT2' or GT_data[col_i]['name'] == 'GT3' or GT_data[col_i]['name'] == 'GT4':
                        GT_data[col_i]['data'].append(GS(col))
                    elif GT_data[col_i]['name'] == 'case':
                        try:
                            if '_' in col:
                                # Resolve SUPP
                                if col[0] == 'S':
                                    GT_data[col_i]['data'].append(2000+int(float(col.split('_')[0][1:])))
                                # Resolve PRO3
                                else:
                                    GT_data[col_i]['data'].append(1000+int(float(col.split('_')[0])))
                            # Resolve IMPROD
                            else:
                                GT_data[col_i]['data'].append(int(float(col)))
                        except:
                            raise Exception('Converision of [' + col + '] failed')
                    else:
                        GT_data[col_i]['data'].append(col)                
            row_no = row_no + 1
    return GT_data


def read_GT_fileRSNA(filename):
    ...
    with open(filename, 'r') as csvfile:
        ...
        for values in spamreader:
            cases.append(int(float(values[0])))
            GT_data1.append(values[1])
            GT_data2.append(values[3])
            GT_data3.append(values[5])
            GT_data4.append(values[7])
            loc_data1.append(values[2])
            loc_data2.append(values[4])
            loc_data3.append(values[6])
            loc_data4.append(values[8])
        row_no = row_no + 1
    return (cases, GT_data1, GT_data2, GT_data3, GT_data4, loc_data1, loc_data2, loc_data3, loc_data4)


def read_GT_fileCWRU(filename):

    # read header
    GS_cases = []
    GS_cases_for_lesions = []
    GS_scores = []
    GS_locations = []
    y_true_values = []
    row_no = 0
    with open(filename, 'r') as csvfile:
        ...
        for row in spamreader:
            case = row[0]
            GSscores = [GS(x) for x in row[2].split('/')]
            locs = row[2].split('/')
            GS_cases.append(case)
            for score_i in range(len(GSscores)):
                GS_scores.append(GSscores[score_i])
                GS_locations.append(locs[score_i])
                GS_cases_for_lesions.append(case)
                if(GSscores[score_i] > GS('3+3')):
                     y_true_values.append(1)
                else:
                     y_true_values.append(0)
    return GS_cases, GS_cases_for_lesions, GS_scores, GS_locations, np.array(y_true_values)


def resolve_case_GS_criteria2(casename, GT_data, case):
    ...
    for col_i in range(len(GT_data)):
        col = GT_data[col_i]
        if col['name'] == 'GT1':
            case_GS1 = GS(str(col['data'][case_row]))
        if col['name'] == 'GT2':
            case_GS2 = GS(str(col['data'][case_row]))
        if col['name'] == 'GT3':
            case_GS3 = GS(str(col['data'][case_row]))
        if col['name'] == 'GT4':
            case_GS4 = GS(str(col['data'][case_row]))
        if col['name'] == 'GT1_s':
            GT_s_all[0] = col['data'][case_row]
        if col['name'] == 'GT2_s':
            GT_s_all[1] = col['data'][case_row]
        if col['name'] == 'GT3_s':
            GT_s_all[2] = col['data'][case_row]
        if col['name'] == 'GT4_s':
            GT_s_all[3] = col['data'][case_row]
    return case_GS1, case_GS2, case_GS3, case_GS4, GT_s_all, case_row


def resolve_case_GS(casename, prefix, GT_data, case):
    
    if prefix == 'L1L2L3L4':
        case_GS_RALP, case_row, case_col, case_col_MRI_L = read_GS_RALP(case)
        return case_GS_RALP, case_row, case_col, case_col_MRI_L
    ...
    if prefix == 'L1':
        ...
        for col_i in range(len(GT_data)):
            col = GT_data[col_i]
            if col['name'] == 'GS_L1':
                case_GS = col['data'][case_row]
                case_col = col_i
            if col['name'] == 'GS_MRI_L1':
                case_col_MRI_L = col_i
        if case_GS is None:
            raise Exception('Failed to find GS_L1 from GT data')
    elif prefix == 'L2':
        case_GS = None
        for col_i in range(len(GT_data)):
            col = GT_data[col_i]
            if col['name'] == 'GS_L2':
                case_GS = col['data'][case_row]
                case_col = col_i
            if col['name'] == 'GS_MRI_L2':
                case_col_MRI_L = col_i
        if case_GS is None:
            raise Exception('Failed to find GS_L2 from GT data')
    elif prefix == 'L3':
        case_GS = None
        for col_i in range(len(GT_data)):
            col = GT_data[col_i]
            if col['name'] == 'GS_L3':
                case_GS = col['data'][case_row]
                case_col = col_i
            if col['name'] == 'GS_MRI_L3':
                case_col_MRI_L = col_i
        if case_GS is None:
            raise Exception('Failed to find GS_L3 from GT data')
    elif prefix == 'L4':
        case_GS = None
        for col_i in range(len(GT_data)):
            col = GT_data[col_i]
            if col['name'] == 'GS_L4':
                case_GS = col['data'][case_row]
                case_col = col_i
            if col['name'] == 'GS_MRI_L4':
                case_col_MRI_L = col_i
        if case_GS is None:
            raise Exception('Failed to find GS_L4 from GT data')
    else:
        raise Exception('Uknown prefix for GS:' + prefix)
    #print((case_GS, case_row, case_col, case_col_MRI_L, prefix))
    #print(GS(str(case_GS)))
    return GS(str(case_GS)), case_row, case_col, case_col_MRI_L


def resolve_case_GSsum(casename, GT_data, case):
    case_row = -1
    for row_i in range(len(GT_data[0]['data'])):
        if GT_data[0]['data'][row_i] == case:
            case_row = row_i
    ...
    for col_i in range(len(GT_data)):
        col = GT_data[col_i]
        if col['name'] == 'GS sum SB':
            case_GS_SB = GS(col['data'][case_row])
            case_col_SB = col_i
        if col['name'] == 'GS sum TB':
            case_GS_TB = GS(col['data'][case_row])
            case_col_TB = col_i

    if case_GS_SB > case_GS_TB:
        case_GS = case_GS_SB
        case_col = case_col_SB
    else:
        case_GS = case_GS_TB
        case_col = case_col_TB
    case_GS = GS(str(case_GS))
    print(('case_GS_SB', case_GS_SB,'case_GS_TB', case_GS_TB,'case_GS', case_GS))
            
    return case_GS, case_row, case_col, case_col_MRI_L


def filterfun_include_all(casename, prefix, GT_data, case):
    case_GS, case_row, case_col, case_col_MRI_L = resolve_case_GS(casename, prefix, GT_data, case)
    return True, case_GS
def filterfun_Grade_1(casename, prefix, GT_data, case):
    case_GS, case_row, case_col, case_col_MRI_L = resolve_case_GS(casename, prefix, GT_data, case)
    return (case_GS == GS('3+3') or case_GS == GS('3+2')), case_GS
def filterfun_Grade_1plus(casename, prefix, GT_data, case):
    case_GS, case_row, case_col, case_col_MRI_L = resolve_case_GS(casename, prefix, GT_data, case)
    return (case_GS == GS('3+3+3') or case_GS == GS('3+3+4') or case_GS == GS('3+3+5')), case_GS
def filterfun_Grade_2(casename, prefix, GT_data, case):
    case_GS, case_row, case_col, case_col_MRI_L = resolve_case_GS(casename, prefix, GT_data, case)
    return (case_GS == GS('3+4')), case_GS
def filterfun_Grade_2plus(casename, prefix, GT_data, case):
    case_GS, case_row, case_col, case_col_MRI_L = resolve_case_GS(casename, prefix, GT_data, case)
    return (case_GS == GS('3+4+3') or case_GS == GS('3+4+4') or case_GS == GS('3+4+5')), case_GS
def filterfun_Grade_3(casename, prefix, GT_data, case):
    case_GS, case_row, case_col, case_col_MRI_L = resolve_case_GS(casename, prefix, GT_data, case)
    return (case_GS == GS('4+3')), case_GS
def filterfun_Grade_3plus(casename, prefix, GT_data, case):
    case_GS, case_row, case_col, case_col_MRI_L = resolve_case_GS(casename, prefix, GT_data, case)
    return (case_GS == GS('4+3+3') or case_GS == GS('4+3+4') or case_GS == GS('4+3+5')), case_GS
def filterfun_Grade_4(casename, prefix, GT_data, case):
    case_GS, case_row, case_col, case_col_MRI_L = resolve_case_GS(casename, prefix, GT_data, case)
    return (case_GS == GS('4+4') or case_GS == GS('3+5') or case_GS == GS('4+5')), case_GS
def filterfun_Grade_5(casename, prefix, GT_data, case):
    case_GS, case_row, case_col, case_col_MRI_L = resolve_case_GS(casename, prefix, GT_data, case)
    return (case_GS > GS('4+5+5')), case_GS
def filterfun_33_only(casename, prefix, GT_data, case):
    case_GS, case_row, case_col, case_col_MRI_L = resolve_case_GS(casename, prefix, GT_data, case)
    return (case_GS == GS('3+3')), case_GS
def filterfun_33_higher(casename, prefix, GT_data, case):
    # find row number
    case_GS, case_row, case_col, case_col_MRI_L = resolve_case_GS(casename, prefix, GT_data, case)
    return (case_GS > GS('3+3')), case_GS
def filterfun_34_higher(casename, prefix, GT_data, case):
    # find row number
    case_GS, case_row, case_col, case_col_MRI_L = resolve_case_GS(casename, prefix, GT_data, case)
    return (case_GS > GS('3+4')), case_GS
def filterfun_34_only(casename, prefix, GT_data, case):
    # find row number
    case_GS, case_row, case_col, case_col_MRI_L = resolve_case_GS(casename, prefix, GT_data, case)
    return (case_GS == GS('3+4')), case_GS
def filterfun_43_only(casename, prefix, GT_data, case):
    # find row number
    case_GS, case_row, case_col, case_col_MRI_L = resolve_case_GS(casename, prefix, GT_data, case)
    return (case_GS == GS('4+3')), case_GS
def filterfun_43_higher(casename, prefix, GT_data, case):
    # find row number
    case_GS, case_row, case_col, case_col_MRI_L = resolve_case_GS(casename, prefix, GT_data, case)
    return (case_GS > GS('4+3')), case_GS
def filterfun_include_all36(casename, prefix, GT_data, case):
    case_GS, case_row, case_col, case_col_MRI_L = resolve_case_GS(casename, prefix, GT_data, case)
    if str(GT_data[case_col+2]['data'][case_row]) == 'x':
        return False, case_GS
    if str(GT_data[case_col_MRI_L]['data'][case_row]) == 'x':
        return False, case_GS
    return True, case_GS
def filterfun_33_only36(casename, prefix, GT_data, case):
    # find row number
    case_GS, case_row, case_col, case_col_MRI_L = resolve_case_GS(casename, prefix, GT_data, case)
    if str(GT_data[case_col+2]['data'][case_row]) == 'x':
        return False, case_GS
    if str(GT_data[case_col_MRI_L]['data'][case_row]) == 'x':
        return False, case_GS
    return (case_GS == GS('3+3')), case_GS
def filterfun_34_only36(casename, prefix, GT_data, case):
    # find row number
    case_GS, case_row, case_col, case_col_MRI_L = resolve_case_GS(casename, prefix, GT_data, case)
    if str(GT_data[case_col+2]['data'][case_row]) == 'x':
        return False, case_GS
    if str(GT_data[case_col_MRI_L]['data'][case_row]) == 'x':
        return False, case_GS
    return (case_GS == GS('3+4')), case_GS
def filterfun_43_only36(casename, prefix, GT_data, case):
    # find row number
    case_GS, case_row, case_col, case_col_MRI_L = resolve_case_GS(casename, prefix, GT_data, case)
    if str(GT_data[case_col+2]['data'][case_row]) == 'x':
        return False, case_GS
    if str(GT_data[case_col_MRI_L]['data'][case_row]) == 'x':
        return False, case_GS
    return (case_GS == GS('4+3')), case_GS
def filterfun_43_higher36(casename, prefix, GT_data, case):
    # find row number
    case_GS, case_row, case_col, case_col_MRI_L = resolve_case_GS(casename, prefix, GT_data, case)
    if str(GT_data[case_col+2]['data'][case_row]) == 'x':
        return False, case_GS
